...
AdventureGuideTabFrameMixin = {}

function AdventureGuideTabFrameMixin:OnLoad()

end

function AdventureGuideTabFrameMixin:OnTabSelected(tab, index)
...
function AdventureGuideTabFrameMixin:CreateTabButtons(tabs)
